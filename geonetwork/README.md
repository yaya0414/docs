...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/geonetwork/badge/icon) (`ppc64le/geonetwork` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/geonetwork/)
