...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/flink/badge/icon) (`i386/flink` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/flink/)
...
The `i386/flink` images come in many flavors, each designed for a specific use case.

## `i386/flink:<version>`

This is the defacto image. If you are unsure about what your needs are, you probably want to use this one. It is designed to be used both as a throw away container (mount your source code and start the container to start your app), as well as the base to build other images off of.

## `i386/flink:<version>-alpine`
